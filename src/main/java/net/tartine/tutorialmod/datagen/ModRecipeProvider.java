...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        oreSmelting(consumer, List.of(ModItems.RED_PEARL.get()), RecipeCategory.MISC,
                ModItems.CYAN_PEARL.get(), 2f, 200, "cyan_pearl");

        nineBlockStorageRecipes(consumer, RecipeCategory.BUILDING_BLOCKS, ModItems.RED_PEARL.get(), RecipeCategory.MISC,
                ModBlocks.RED_PEARL_BLOCK.get());

        //Shaped Template

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.HAZARD_BLOCK.get())
                .define('B', ModItems.CYAN_PEARL.get())
                .pattern("BBB")
                .pattern("B B")
                .pattern("BBB")
                .unlockedBy("has_cyan_pearl", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(ModItems.CYAN_PEARL.get()).build()))
                .save(consumer);
